...
@NoArgsConstructor
public class MandatoryResourceException extends Exception
{
	/**
	 * Auto-generated ID
	 */
	...
	public MandatoryResourceException(int id, String message, Exception exception)
	{
		super();
		this.id = id;
	...
	public MandatoryResourceException(int id, String message)
	{
		super();
		this.id = id;
		this.message = message;
