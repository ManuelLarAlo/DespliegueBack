...
public class ForbiddenException extends Exception
{
	 ...
	 * Auto-generated ID
	 */
	private static final long serialVersionUID = 8144321039123138731L;
	...
	public ForbiddenException(int id, String message, Exception exception)
	{
		super();
		this.id = id;
	...
	public ForbiddenException(int id, String message)
	{
		super();
		this.id = id;
		this.message = message;
