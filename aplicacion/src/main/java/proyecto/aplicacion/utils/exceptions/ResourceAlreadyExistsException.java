...
public class ResourceAlreadyExistsException extends Exception
{
	 ...
	 * Auto-generated ID
	 */
	private static final long serialVersionUID = 8144321039123138733L;
	...
	public ResourceAlreadyExistsException(int id, String message, Exception exception)
	{
		super();
		this.id = id;
	...
	public ResourceAlreadyExistsException(int id, String message)
	{
		super();
		this.id = id;
		this.message = message;
