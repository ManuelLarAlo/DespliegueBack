...
public class SessionExpiredException extends Exception
{
    ...
    public SessionExpiredException(int id, String message, Exception exception) {
        super();
        this.id = id;
    ...
    public SessionExpiredException(int id, String message) {
        super();
        this.id = id;
        this.message = message;
    }
    ...
    public Map<String, String> getMapError()
    {
        ...
        if (this.exception != null) {
            String stacktrace = ExceptionUtils.getStackTrace(this.exception); // -> requiere una dependencia de Apache commons.
